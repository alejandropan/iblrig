...
def get_psych_data(tph): ##All rew lines by @alejandro
    ...
    prop_rew_ccw04 = get_prop_ccw_rew(0.4) #Addition @alejandro
    prop_rew_ccw08 = get_prop_ccw_rew(0.8) #Addition @alejandro

    return sig_contrasts_all, prop_resp_ccw02, prop_resp_ccw05, prop_resp_ccw08, prop_rew_ccw04, prop_rew_ccw08, prop_rew_ccw05
...
def get_chron_data(tph):
    ...
    rts02, rts05, rts08, rts_rew04, rts_rew08, rts_rew05 = get_rts(0.2), get_rts(0.5), get_rts(0.8), get_rew_rts(0.4), get_rew_rts(0.8), get_rew_rts(0.5)

    return sig_contrasts_all, rts02, rts05, rts08, rts_rew04, rts_rew08, rts_rew05
...
def plot_rew_psych(psych_data, ax=None):
    ...
    ax.plot(x, y04, c='g', label='CCW responses 40/80', marker='o', ls='-')
    ax.plot(x, y08, c='b', label='CCW responses 80/40', marker='o', ls='-')
